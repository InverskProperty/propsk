        ...
        try {
            ...
            try (Connection conn = DriverManager.getConnection(url, user, password)) {
                ...
                try (Statement stmt = conn.createStatement();
                    ...
                    System.out.println("\n" + "=".repeat(60));
                    System.out.println(String.format("GRAND TOTAL (12 MONTHS): £%,.2f", grandTotal));
                }
                
                // Now check last 2 years
                System.out.println("\n\n=== UNIFIED_TRANSACTIONS - INCOMING PAYMENTS (LAST 24 MONTHS) ===\n");

                String query2 = "SELECT transaction_type, COUNT(*) as count, SUM(amount) as total " +
                              "FROM unified_transactions " +
                ...
                try (Statement stmt = conn.createStatement();
                    ...
                    System.out.println("\n" + "=".repeat(60));
                    System.out.println(String.format("GRAND TOTAL (24 MONTHS): £%,.2f", grandTotal));
                }
