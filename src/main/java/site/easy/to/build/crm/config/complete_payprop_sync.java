...
public class PayPropSyncService {
    ...
    private PayPropPropertyDTO convertPropertyToPayPropFormat(Property property) {
        ...
        settings.setEnable_payments(property.getEnablePayments());
        settings.setHold_owner_funds(property.getHoldOwnerFunds());
    ...
    private PayPropTenantDTO convertTenantToPayPropFormat(Tenant tenant) {
        ...
        dto.setCustomer_id(tenant.getCustomerId());
        ...
        dto.setNotify_email(tenant.getNotifyEmail());
        dto.setNotify_sms(tenant.getNotifySms());
